...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<bool>(CONFIG_ALLOW_TWO_SIDE_DUNGEON_FINDER, "AllowTwoSide.DungeonFinder", false);
    SetConfigValue<bool>(CONFIG_ALLOW_CROSSFACTION_DUNGEON, "AllowTwoSide.DungeonFinder.CrossFaction", true);
